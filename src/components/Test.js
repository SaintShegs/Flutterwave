// This is a test component that is used to display the payment modal.

// It is not a working component, but a test component.

// It is not part of the project, but a test component.
                ...
                <div className="modal-content">
                    ...
                    <form method="POST" action="https://checkout.flutterwave.com/v3/hosted/pay">
                      ...
                      <div className="inputs">
                        ...
                        <button onKeyDown={this.handleCommand} role='button' type="submit" id="start-payment-button">Sign up</button>
